            ...
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
                <div className="flex flex-col lg:flex-row justify-between items-start mb-12 sm:mb-16 border-b border-white/10 pb-6 sm:pb-8">
                    <div className="w-full lg:w-1/2 mb-6 sm:mb-8 lg:mb-0">
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-normal text-white font-space-grotesk leading-tight">
                    ...
                    <div className="w-full lg:w-1/2 lg:pl-8 xl:pl-12">
                        <p 
                            className="text-white/70 text-base sm:text-lg leading-tight font-red-hat text-left lg:text-right"
                    ...
                    {procesoData.steps.map((proceso, index) => (
                        ...
                        >
                            <div className="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 flex items-center justify-center">
                                <span className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-white group-hover:text-[#B2FF00]/40 transition-colors duration-300 font-red-hat font-semibold leading-none">
                                    {proceso.numero}
                                </span>
                            </div>

                            <div className="flex-1 min-w-0">
                                <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-normal text-white group-hover:text-[#B2FF00] transition-colors duration-300 font-space-grotesk mb-2 sm:mb-3 leading-tight">
                                    {proceso.titulo}
                                </h3>
                                <p className="text-white/50 text-sm sm:text-base lg:text-lg leading-relaxed font-space-grotesk group-hover:text-white/90 transition-colors duration-300">
                                    {proceso.descripcion}
                                </p>
                            </div>
                        </div>
