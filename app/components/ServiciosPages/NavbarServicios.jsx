              ...
              <TextCarousel
                ...
                renderItem={(proyecto) => (
                  <div className="flex flex-row items-center gap-3 whitespace-nowrap flex-shrink-0">
                    <p className="font-red-hat font-bold text-[#464646] text-sm md:text-base tracking-[-0.32px] leading-none">
                      {proyecto.title}
                    </p>
                    <span className="bg-[#464646] rounded-full w-[3px] h-[3px] flex-shrink-0" />
                    <p className="font-red-hat font-medium text-[#707070] text-sm md:text-base tracking-[-0.32px] leading-none">
