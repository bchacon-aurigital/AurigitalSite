...
function PlanCard({ name, price, timeline, idealPara, features, featured, idealParaLabel, buttonText }) {
  return (
  ...
  return (
    <section className="bg-[#e9e9e9] px-6 md:px-10 lg:px-14 py-10 lg:py-16">
      <div className="max-w-7xl mx-auto">
        ...
        >
          {plans.map((plan, i) => (
            <PlanCard key={i} {...plan} featured={i === 1} idealParaLabel={idealParaLabel} buttonText={buttonText} />
          ))}
        </div>
