      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-qurova font-medium leading-tight">
              {referralData.title}
            </h2>
          </div>
          ...
          <div className="bg-black/10 rounded-xl p-4 sm:p-6 mb-6">
            <div className="text-center">
              <div className="text-lg sm:text-xl lg:text-2xl font-qurova font-medium mb-2">
        ...
        >
          <div className="flex items-center gap-4 mb-8">
            ...
            <h3 className="text-white text-xl sm:text-2xl lg:text-3xl font-qurova font-medium">
              Características
            </h3>
          </div>
          ...
          <div className="space-y-6">
            {referralData.features.map((feature, index) => (
              ...
              >
                ...
                <p className="text-[#D4D4D4]/80 text-sm sm:text-base leading-relaxed font-mansfield">
                  {feature}
                </p>
              </div>
            ))}
          ...
          <div className="mt-8 p-4 bg-[#B2FF00]/10 rounded-xl border border-[#B2FF00]/20">
            <div className="flex items-center gap-2 text-[#B2FF00] text-sm font-qurova font-medium uppercase mb-2">
              <ArrowRight className="w-4 h-4" />
              Ejemplo
            </div>
            <p className="text-white text-sm sm:text-base font-mansfield">
