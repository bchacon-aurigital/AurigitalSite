...
const WA_HREF = 'https://wa.me/50688888169?text=Hola!%20Me%20gustar%C3%ADa%20cotizar%20un%20proyecto%20de%20dise%C3%B1o%20web'

const breadcrumbItems = [
  { name: 'Inicio', url: 'https://aurigital.com' },
  { name: 'Servicios', url: 'https://aurigital.com/servicios' },
  { name: 'Diseño Web San José', url: 'https://aurigital.com/diseno-web-san-jose' },
]
...
export default function DisenoWebSanJose() {
  const { translations } = useLanguage()
  const { openModal } = useContactModal()
  const t = translations.disenoWebSanJose ?? {}
  ...
  return (
    <>
      ...
      <StructuredData data={getServiceSchema(
        'Diseño Web San José',
        'Diseño web San José a medida: prototipo navegable, UI alineada a tu marca, web rápida y móvil impecable. Para marcas con reputación.',
        '$$-$$$'
      )} />
    ...
    <main className="bg-[#E9E9E9] overflow-x-hidden">
      ...
      <section className="relative px-6 md:px-10 lg:px-14 pt-28 md:pt-36 pb-16 lg:pb-24 bg-[#E9E9E9]">
        ...
        <div data-aos="fade-up" data-aos-delay="200" className="max-w-[1400px] mx-auto mt-12 lg:mt-16">
          <div className="w-full aspect-[16/9] md:aspect-[16/9] rounded-2xl overflow-hidden">
            <video
